 ...
 */
public class MessageStoreMMap {

    private static final MessageStoreMMap INSTANCE = new MessageStoreMMap();

    public static MessageStoreMMap getInstance() {
        return INSTANCE;
    }

    private static Lock lock = new ReentrantLock();

    private static final int LOG_FILE_MAX = 2 * 1024 * 1024;

    private static final int LOG_PARTITION_MIN = 256 * 1024;
    ...
    public void putMessage(String bucket, Message msg, KeyValue props) throws IOException {
        ...
        if (buf.remaining() < LOG_PARTITION_MIN) {
        ...
        buf.putInt(1);
        MsgSerializer.serialize(msg, buf);
    }
    ...
    public Message pullMessage(String bucket, KeyValue props) throws IOException {
        ...
        return MsgSerializer.deserialize(buf);
    }
